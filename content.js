...
function replaceProfilePictures() {
  ...
  profilePics.forEach(pic => {
    if (pic.alt.toLowerCase().includes("profile photo") || pic.classList.contains("EntityPhoto-circle-0") || pic.classList.contains("EntityPhoto-circle-3") || pic.classList.contains("EntityPhoto-square-3") || pic.classList.contains("evi-image") ||pic.classList.contains("EntityPhoto-circle-3-ghost-person") || pic.classList.contains("Elevation-0dp") || pic.classList.contains("discover-entity-type-card__image-circle--dash") || pic.classList.contains("ivm-view-attr__ghost-entity") ){
